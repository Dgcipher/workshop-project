    ...
    Route::prefix('user-management')->group(function () {
        Route::prefix('/users')->middleware('UserAPIAuthorization:' . PrivacyEnums::USERS)->group(function () {
            ...
            Route::prefix('/{id}')->group(function () {
                Route::get('/', [UserController::class, 'read'])->middleware('PreventSuperAdminOperations:' . PrivacyEnums::USERS . ',read');
                Route::put('/', [UserController::class, 'update'])->middleware('PreventSuperAdminOperations:' . PrivacyEnums::USERS . ',update');
                Route::delete('/', [UserController::class, 'delete'])->middleware('PreventSuperAdminOperations:' . PrivacyEnums::USERS . ',delete');
                Route::prefix('/roles/{role_id}')->group(function () {
                    Route::post('/', [UserController::class, 'assignRole'])->middleware('PreventSuperAdminOperations:' . PrivacyEnums::USERS . ',assign_role');
                    Route::delete('/', [UserController::class, 'unassignRole'])->middleware('PreventSuperAdminOperations:' . PrivacyEnums::USERS . ',unassign_role');
                });
            });
        });
    });
